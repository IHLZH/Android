package com.example.homework_activity_jump.homeWorkAdapter;
...
import com.example.homework_activity_jump.Activity.ShopCarActivity;
...
public class ShopCarAdapter extends BaseAdapter {
    ...
    private List<? extends Shop> shopCarList;

    public ShopCarAdapter(){};
    public ShopCarAdapter(Context context, Integer layoutId, List shopCarList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(Shop shop1 : shopCarList){
                    sumOfPrice += Double.parseDouble(shop1.getPrice()) * shop1.getNum();
                }
                ShopCarActivity.tv_sum_price.setText(sumOfPrice.toString());
            }
        });
